...
This package contains data that was used for Holland Stam's thesis work, which sought to understand which types of artists were over or underrepresented in art history education throughout the years. Stam collected the data by manually taking measurements of both Garder and Janson's art history textbooks, which are the two most popular textbooks used in the American education system. **Holland please edit**
